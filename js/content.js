...
window.DEFAULT_CONTENT = {
  es: {
    ...
    agenda: {
      ...
      items: [
        { event: 'Transporte redondo Aeropuerto / Hotel', day: 'TBD', time: 'TBD', place: 'Aeropuerto - Hotel', pax: '20', total: '$5,200.00', description: 'Traslado redondo en camioneta Sprinter para 20 personas y 15 maletas. Exenta de impuestos por traslados locales; se factura con IVA en 0.' },
        { event: 'Menú Ejecutivo · Día 1', day: 'Día 1', time: 'TBD', place: 'Rest. Terraza', pax: '20', total: '$39,300.00', description: 'Desayuno Americano, Menú del Mediodía 2 tiempos, Cena Menú Especial Perla 3 tiempos.' },
        { event: 'Coffee Break', day: 'TBD', time: '6 horas', place: 'Salón El Mechudo', pax: '20', total: '$9,600.00', description: 'Coffee break básico continuo por 6 horas para 20 personas.' },
        { event: 'Menú Ejecutivo · Día 2', day: 'Día 2', time: 'TBD', place: 'Rest. Terraza', pax: '20', total: '$39,300.00', description: 'Desayuno Americano, Menú del Mediodía 2 tiempos, Cena Menú Especial Perla 3 tiempos.' },
    ...
    rooms: {
      ...
      types: [
        { imageKey: 'roomDouble', alt: '2 camas dobles', title: '2 Camas Dobles (38 habitaciones)', size: '25.08 m² / 270 sq ft' },
        { imageKey: 'roomKing', alt: '1 cama king con terraza', title: '1 Cama King con Terraza (48 habitaciones)', size: '30.93 m² / 333 sq ft · terraza privada' }
      ],
  ...
  en: {
    ...
    agenda: {
      ...
      items: [
        { event: 'Round-trip Airport / Hotel Transportation', day: 'TBD', time: 'TBD', place: 'Airport - Hotel', pax: '20', total: '$5,200.00', description: 'Round-trip Sprinter van transfer for 20 people and 15 suitcases. Exempt from taxes for local transfers; billed at 0% VAT.' },
        { event: 'Executive Menu · Day 1', day: 'Day 1', time: 'TBD', place: 'Terraza Restaurant', pax: '20', total: '$39,300.00', description: 'American breakfast, 2-course midday menu, 3-course Perla Special dinner menu.' },
        { event: 'Coffee Break', day: 'TBD', time: '6 hours', place: 'El Mechudo Room', pax: '20', total: '$9,600.00', description: 'Basic continuous coffee break for 6 hours, 20 people.' },
        { event: 'Executive Menu · Day 2', day: 'Day 2', time: 'TBD', place: 'Terraza Restaurant', pax: '20', total: '$39,300.00', description: 'American breakfast, 2-course midday menu, 3-course Perla Special dinner menu.' },
        { event: 'Year-end Dinner', day: 'TBD', time: '4 hours', place: 'Madre Perla Terrace', pax: '20', total: '$38,706.40', description: 'National open bar (Margarita, Paloma, Charro Negro, Michelada, Tequila Centenario Blanco, Torres Brandy, Bacardí White Rum, Smirnoff Vodka, Johnny Walker Red Label Whisky). Includes special banquet setup: round table, crossback chair, linens, napkins, glass and base plate.' }
      ],
    ...
    rooms: {
      ...
      types: [
        { imageKey: 'roomDouble', alt: '2 double beds', title: '2 Double Beds (38 rooms)', size: '25.08 m² / 270 sq ft' },
        { imageKey: 'roomKing', alt: '1 king bed with terrace', title: '1 King Bed with Terrace (48 rooms)', size: '30.93 m² / 333 sq ft · private terrace' }
      ],
